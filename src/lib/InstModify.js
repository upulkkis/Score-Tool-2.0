...
return(
    <tr>
      <Tooltip followCursor title={<Helps help="AnScorenames"/>} disableTouchListener={!props.help} disableHoverListener={!props.help} sx={{zIndex:99999}}>
    <td key={"scor"+state.idx} style={{backgroundColor:state.color}}>{state.scoreNames}</td>
    </Tooltip>
    <Tooltip followCursor title={<Helps help="AnTech"/>} disableTouchListener={!props.help} disableHoverListener={!props.help} sx={{zIndex:99999}}>
    <td key={"tec"+state.idx}>{state.scoreTechs}</td>
    </Tooltip>
    <Tooltip followCursor title={<Helps help="AnDyn"/>} disableTouchListener={!props.help} disableHoverListener={!props.help} sx={{zIndex:99999}}>
    ...
    <Tooltip followCursor title={<Helps help="AnMicro"/>} disableTouchListener={!props.help} disableHoverListener={!props.help} sx={{zIndex:99999}}>
    <td key={"micro"+state.idx}>{selectMicrotone()}</td>
    </Tooltip>
    <Tooltip followCursor title={<Helps help="AnTgt"/>} disableTouchListener={!props.help} disableHoverListener={!props.help} sx={{zIndex:99999}}>
    ...
    <Tooltip followCursor title={<Helps help="AnOnoff"/>} disableTouchListener={!props.help} disableHoverListener={!props.help} sx={{zIndex:99999}}>
    ...
    <Tooltip followCursor title={<Helps help="AnMo"/>} disableTouchListener={!props.help} disableHoverListener={!props.help} sx={{zIndex:99999}}>
